---
title: "EpiGIFT_Seurat_Compare_ListGenes"
...
dir.create(path = paste0(directory, "exp/scRNAseq_EpiGIFT_Seurat_Compare_ListGenes/"))
directory_output = paste0(directory, "exp/scRNAseq_EpiGIFT_Seurat_Compare_ListGenes/")
...
saveRDS(list_seurat_obj, file = paste0(directory_output, "list_seurat_obj_sctnorm.rds"))
...
dir = paste0(directory, "exp/scRNAseq_EpiGIFT_Seurat_FindMarkersList/")
...
FindMarkers_FC_wilcox = function(list_seurat, drugs_choice, list_genes) {
  ...
  colnames(tab_wilcox) = "p.value"
  tab_wilcox = tab_wilcox %>% 
    tibble::rownames_to_column("gene") %>%
    dplyr::mutate(p.adj = p.adjust(tab_wilcox$p.value, "bonferroni", nrow(tab_wilcox)))
...
saveRDS(EG_FindMarkerscalcul_CTRLDON, paste0(directory_output, "EG_FindMarkerscalcul_CTRLDON.rds"))
# saveRDS(EG_FindMarkerscalcul_CTRL2DG, paste0(directory_output, "EG_FindMarkerscalcul_CTRL2DG.rds"))
# saveRDS(EG_FindMarkerscalcul_CTRLAOA, paste0(directory_output, "EG_FindMarkerscalcul_CTRLAOA.rds"))
