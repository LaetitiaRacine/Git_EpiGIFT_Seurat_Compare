...
**Step3 : Graphical representation with pvalueEG on y axis and pvalueFM on x axis**  
```{r}
...
ggplot(data = tab_all_genes, aes(x=pvalueFM, y=pvalueEG, fill=list_category)) +
  geom_point() +
