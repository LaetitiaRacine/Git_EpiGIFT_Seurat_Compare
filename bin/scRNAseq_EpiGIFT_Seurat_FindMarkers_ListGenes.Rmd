...
dir.create(path = paste0(directory, "exp/scRNAseq_EpiGIFT_Seurat_FindMarkersList/"))
directory_output = paste0(directory, "exp/scRNAseq_EpiGIFT_Seurat_FindMarkersList/")
